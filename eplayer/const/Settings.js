...
export const resources = {
  ...
  links: {
    ...
    spectrumServiceUrl: {
      local: 'https://spectrum-qa.pearsoned.com/api/v1/context',
      dev: 'https://spectrum-qa.pearsoned.com/api/v1/context',
      qa: 'https://spectrum-qa.pearsoned.com/api/v1/context',
      stage: 'https://spectrum-stg.pearsoned.com/api/v1/context',
      PERF: 'https://spectrum-ppe.pearsoned.com/api/v1/context',
      prod: 'https://spectrum.openclass.com/api/v1/context'
    },
    iseUrl: {
    ...
    xCaller: {
      local: {
        ETEXT2_WEB: {
          ETEXT2_PXE: '3cc7b6e8-3416-11e8-b467-0ed5f89f718b',
          ETEXT2_SMS: '3cc7b968-3416-11e8-b467-0ed5f89f718b'
        }
      },
      dev: {
        ETEXT2_WEB: {
      ...
      stage: {
        ETEXT2_WEB: {
          ETEXT2_PXE: 'f50674e2-3416-11e8-b467-0ed5f89f718b',
          ETEXT2_SMS: 'f5067834-3416-11e8-b467-0ed5f89f718b'
        }
      },
      prod: {
        ETEXT2_WEB: {
          ETEXT2_PXE: 'a66ec434-c1d5-4ce6-864c-70121c11524c',
          ETEXT2_SMS: '95ac568d-eef9-4bf5-9f8b-86c7fa7afa2d'
        }
      }
    }
  }
